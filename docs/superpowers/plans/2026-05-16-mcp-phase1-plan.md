...
- [x] **Step 3: 更新 server.py 调用 register**
...
- [x] **Step 1: 更新 server.py 导出 http_app**
...
- [x] **Step 3: 验证全部 3 个工具可通过 Python 调用**
